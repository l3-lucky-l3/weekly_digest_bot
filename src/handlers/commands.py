...
/selectannouncetopic <название> - установить текущий топик для постов в понедельник
/selectdigesttopic <название> - установить текущий топик для дайджестов в пятницу
