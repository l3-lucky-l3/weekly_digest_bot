...
/selectconductortopic <название> - установить текущий топик для постов в понедельник
/selectanouncestopic <название> - установить текущий топик для дайджестов в пятницу
